...
const Mainservice = () => {
    ...
    <div>
       ...
       <div className='flex-column container'>
        ...
        <p className='servicetext container'>Property management services are designed to transform real estate investments into seamless,hassle-free experiences.Bolaji Aderibigbe and his team,manage every aspect of your property with precision
...
enjoy the benefits of your investment without the day-to-day complexities.</p>
       </div>
       <div className='flex-column container'>
        ...
        <p className='servicetext container'>Navigating the real estate landscape requires insight, experience, and strategic thinking. Bolaji
