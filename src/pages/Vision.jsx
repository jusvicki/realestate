const Vision = () => {
    return ( 
        <div className="vision">
            <p>
         Bolaji Aderibigbe is a visionary real estate developer and investor with a proven track record of delivering
         ...
         <p>
         Bolaji Aderibigbe is a Nigerian Real Estate Mogul, Developer, and Consultant. A member of the Real Estate
         ...
         realtor he is a member of the Association of Estate Agent of Nigeria.
         </p>
   <p>
    The passion to create a sustainable value in Real Estate led him to pursue a career in the sector in the year
...
<p>
 ...
 <p>
      Bolaji Aderibigbe is a seasoned developer, who has developed projects from residential to commercial as
 ...
 <h1>Vision</h1>
 <p>
"To create and inspire timeless architectural landmarks that enrich communities while
leveraging my platform to foster positive social impact through charitable initiatives,
leaving a lasting legacy of beauty, innovation, and compassion.</p>


 <h1>Mission</h1>
 <p>
 "As a real estate developer, my mission is to design and build exceptional, enduring properties
...
significant and positive difference in both the built environment and the lives of individuals.
 </p>
   </div>
     );
}
