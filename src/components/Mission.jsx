    ...
    <>
      <div className='container-fluid mission' style={{backgroundColor:'#151E3D'}}>
        <div className="container">
          ...
          <p className="foreword text-center mx-auto mt-4 text-light mb-15 text-nowrap">
          ...
          <button
            onClick={handleClick}
            className="btn-light seebutton rounded-pill mx-auto text-primary-700 d-flex p-2 px-4 border-0 text-center align-items-center justify-content-center fw-bolder"
